...
// India-first: INR is the default display currency for all new users.
export const DEFAULT_CURRENCY = "INR";

// All amounts are STORED in this base currency; display converts on top.
export const BASE_CURRENCY = "INR";

const DEFAULT = CURRENCIES[0]; // INR
